...
common_cflags := \
    -g0 \                  # 完全禁止调试信息生成
    -Os \                  # 优化尺寸（相比-O2更有利于减小体积）
    -fno-builtin \         # 禁止内建函数优化
    -fvisibility=hidden \  # 默认隐藏所有符号
    -fno-exceptions \      # 禁用异常处理相关代码
    -fno-unwind-tables \   # 禁用堆栈展开表
    -fno-asynchronous-unwind-tables \  # 禁用异步展开表
    -ffunction-sections \  # 为链接器优化做准备
    -fdata-sections \      # 为链接器优化做准备
    -DNDEBUG               # 禁用assert断言
